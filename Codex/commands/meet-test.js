...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.setDescription('Crée un message de session')
		...
		.addStringOption((option) => option.setName('plateforme').setDescription('Plateforme du meeting').setRequired(true)),
	...
	async execute(interaction) {
		...
		<:3606playingcardspadesace:1078730002343936090>┊➞ 𝗣𝗹𝗮𝘁𝗲𝗳𝗼𝗿𝗺𝗲 : ${interaction.options.getString('plateforme')} 
		﹒┄﹒┄ ﹒┄﹒ ┄﹒┄﹒┄﹒ ┄﹒┄﹒
		...
		<:nice:1083136903555059742> ┊➞ Est-ce que tu seras présent ?
